...
const notionApiKey = process.env.NOTION_PROJECT_API_KEY || process.env.NEXT_PUBLIC_NOTION_N8NSTORE_API;
const notionDatabaseId = process.env.NOTION_PEOJECT_DATABASE_ID || process.env.NEXT_PUBLIC_NOTION_N8NSTORE_DATABASE_ID;
