...
const notionApiKey = process.env.NOTION_PROJECT_API_KEY || process.env.NEXT_PUBLIC_NOTION_STORE_API;
const notionDatabaseId = process.env.NOTION_PEOJECT_DATABASE_ID || process.env.NEXT_PUBLIC_NOTION_STORE_DATABASE_ID;
