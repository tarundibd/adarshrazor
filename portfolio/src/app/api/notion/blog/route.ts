...
const notionApiKey = process.env.NOTION_BLOG_API_KEY || process.env.NEXT_PUBLIC_NOTION_BLOG_API;
const notionDatabaseId = process.env.NOTION_BLOG_DATABASE_ID || process.env.NEXT_PUBLIC_NOTION__BLOG_DATABASE_ID;
